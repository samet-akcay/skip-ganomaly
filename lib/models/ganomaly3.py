...
#TODO: netd -> return features togeter with output score.
...
from lib.models.networksv2 import define_D, define_G, init_net
...
class Ganomaly3:
    ...
    def __init__(self, opt, dataloader=None):
        ...
        if self.opt.resume != '': self.load_weights()
        print(self.netg)
        print(self.netd)
    ...
    def load_weights(self):
        """Load netG and netD weights for the current epoch.
        """        
    ...
    def train(self):
        ...
        print(">> Training model %s." % self.__name__)
